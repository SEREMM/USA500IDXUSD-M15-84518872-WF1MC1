...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Premium Data; USA500IDXUSD; M15 */
/*STRATEGY CODE {"properties":{"entryLots":0.01,"tradeDirectionMode":0,"stopLoss":33,"takeProfit":0,"useStopLoss":true,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"On Balance Volume","listIndexes":[1,0,0,0,0],"numValues":[0,0,0,0,0,0]}],"closeFilters":[{"name":"Bulls Power","listIndexes":[5,0,0,0,0],"numValues":[37,0,0,0,0,0]}]} */
